...
- `index.html`: GitHub Pages entry point, interactive demos, method sections, resources
- `styles.css`: visual design and responsive layout
- `script.js`: demo switching, method tabs, active navigation, BibTeX copy button
